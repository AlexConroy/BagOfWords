...
public class MainMenu extends AppCompatActivity {
    ...
    public void selectGame(int score) {
        ...
        } else if(score >= 700) {                               // Intermediate game play
